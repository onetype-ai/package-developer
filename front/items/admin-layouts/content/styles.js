onetype.AddonReady('admin.layouts', (layouts) =>
{
    layouts.Item({
        ...
        render: function()
        {
            ...
            this.pick = ({ value }) =>
            {
                $ot.admin.screens.open('developer.styles', { tab: value });
            };
            ...
            return `
                <div class="ot-flex-vertical ot-gap-m ot-container-m ot-py-l">
                    ...
                    ></e-admin-global-heading>
                    <div>
                        <e-admin-navigation-tabs tone="contained" :items="tabs" :active="developerStylesTab" :_change="pick"></e-admin-navigation-tabs>
                    </div>
                    <div class="ot-flex-1 ot-scrollbar">
                        <e-admin-data-table :columns="columns" :rows="rows()"></e-admin-data-table>
                    </div>
                </div>
            `;
        }
